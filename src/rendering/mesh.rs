...
impl Mesh {
    ...
    pub fn add_custom(mut self, vertices: Vec<[f32; 3]>, indices: Vec<u32>, normal: [f32; 3]) -> Mesh {
        ...
        vertices.iter().for_each(|position| {
            self.vertices.push(Vertex { position: *position, color, normal, uv: [0.0, 0.0] }) // TODO: Add UVs
        });
